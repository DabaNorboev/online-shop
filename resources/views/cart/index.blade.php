                            ...
                            <div class="item-details">
                                ...
                                <div class="item-actions">
                                    <div class="quantity-control">
                                        <form action="{{ route('cart.items.decrease', $userProduct->id) }}" method="POST">
                                            @csrf @method('PATCH')
                                            <button class="quantity-btn" type="submit">-</button>
                                        </form>
                                        <form action="{{ route('cart.items.update', $userProduct->id) }}" method="POST">
                                            @csrf @method('PATCH')
                                        ...
                                        <form action="{{ route('cart.items.increase', $userProduct->id) }}" method="POST">
                                            @csrf @method('PATCH')
                                            <button class="quantity-btn" type="submit">+</button>
                                        </form>
                                    </div>
